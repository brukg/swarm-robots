...
class FormationControl:
    def __init__(self, pose, leader_index, num_robots, formation_structure, fov_radius, behaviors, fov_radius_avoidance = 0.5):
    ...
    def formation(self):
        ...
        self.velocity = self.velocity + self.behaviors.seperation(self.pose, neighbour_list_avoidance, 1)[:,:2]
